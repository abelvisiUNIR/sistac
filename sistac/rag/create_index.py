...
Uso:
    ...
    py -3 sistac/rag/create_index.py --delete  # eliminar y recrear
...
if __name__ == "__main__":
    ...
    if VECTORSTORE_PROVIDER == "google":
        ...
        from sistac.config import check_gcp_config, GCP_PROJECT_ID, GCP_SEARCH_APP_ID, GCP_DATA_STORE_ID, GCP_LOCATION
        try:
            check_gcp_config()
    ...
    print("  py -3 sistac/rag/index_corpus.py")
