...
Uso:
    python sistac/rag/ragas_eval.py
...
from sistac.config import FIGURES_DIR, TABLES_DIR, PROJECT_ROOT, ensure_dirs
...
def run_ragas_evaluation(eval_dataset: list[dict]) -> dict:
    ...
    llm_judge = ChatAnthropic(model="claude-haiku-4-5")
