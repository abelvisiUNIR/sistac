...
Uso:
    ...
    python sistac/data/mongo_transfer.py --target-db sistac_tfe_backup

    # Copiar a otro servidor MongoDB
    python sistac/data/mongo_transfer.py --target-uri "mongodb://servidor-remoto:27017" --target-db sistac_tfe
"""
