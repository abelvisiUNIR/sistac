...
from sistac.config import H1_REDUCTION_THRESHOLD
...
def efficiency_report(
    ...
    config_name: str,
    alpha: float = 0.05,
    reduction_threshold: float = H1_REDUCTION_THRESHOLD,
) -> dict:
    """
    ...
    Args:
        ...
        reduction_threshold: Reducción mínima exigida (default: H1_REDUCTION_THRESHOLD de config.py)
    ...
    reduction = (median_baseline - median_system) / median_baseline if median_baseline > 0 else 0.0
    ...
    return {
        ...
        "H1_accepted": p_value < alpha and reduction >= reduction_threshold,
    }
